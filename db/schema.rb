...
ActiveRecord::Schema.define(:version => 20150811112845) do
  ...
  create_table "blue_arc_orders", :force => true do |t|
    t.string   "first_name"
    t.string   "last_name"
    t.string   "address"
    t.string   "city"
  ...
  create_table "blue_payments", :force => true do |t|
    t.integer  "user_id"
  ...
  create_table "blue_signs", :force => true do |t|
    t.integer  "blue_payment_id"
    t.text     "signature"
    t.datetime "created_at",      :null => false
    t.datetime "updated_at",      :null => false
  end
